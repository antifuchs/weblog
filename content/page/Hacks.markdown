...
* A gnome [deskbar plugin](/2006/04/a-ssh-plugin-for-deskbar-applet/) for SSH-ing to hosts
* An [SSH plugin for quicksilver](2006/11/more-quicksilverification/).

Watch history unfold at [my github account](https://github.com/antifuchs) and this blog's category [Hacks](/categories/hacks/).
